...
//Added 3 new pages
//Addedd 2 more pages, and adjusted
  pages: PageInterface[] = [
    ...
    {title: 'Personal Project', pageName:'HomePage',tabComponent:'ProjectPage',index: 3, icon: 'bookmarks'},
    {title: 'Team Project',pageName:'HomePage', tabComponent:'TeamprojectPage',index: 4, icon: 'bookmarks'},
    {title: 'Extra Curriculum Activities', pageName: 'HomePage', tabComponent: 'ExtraCurriculumPage', index: 5,  icon: 'list'},
